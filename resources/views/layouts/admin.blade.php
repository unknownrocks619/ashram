...
<head>
  ...
  <!-- BEGIN: Body-->
  <body class="vertical-layout vertical-menu-modern dark-layout 2-column  navbar-sticky footer-static bg-full-screen-image @if( ! Auth::guard('admin')->check()) blank-page @endif" data-open="click" data-menu="vertical-menu-modern" data-col="2-column" data-layout="dark-layout">
    <!-- BEGIN: Content-->
